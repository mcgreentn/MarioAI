...
import competition.cig.mechanicextractor.extractor.GraphBuilder;
	...
	private class SearchNode
	{
		...
		public float simulatePos()
		{
	    	...
	    	for (int i = 0; i < repetitions; i++)
	    	{
	    		...
	    		/*if (debugPos < 1000)
	    		{
	    			GlobalOptions.Pos[debugPos][0] = ( fint) levelScene.mario.x;
	    			GlobalOptions.Pos[debugPos][1] = (int) levelScene.mario.y;
	    			debugPos++;
	    		}*/
	    		if (debugPos > 1000)
	    	...
	    	// Compare states from parent to child. See what changed
	    	GraphBuilder.compareStates(parentPos.sceneSnapshot, sceneSnapshot);
		...
		public ArrayList<SearchNode> generateChildren()
		{
			...
			{
				SearchNode child = new SearchNode(action, repetitions, this);
				list.add(child);
			}
			return list;
		}
