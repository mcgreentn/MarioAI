...
//modified lines with requireReplanning so that it's always false
//requireReplanning is true only if Mario has taken damage, thus setting it to false tells the AI that Mario isn't taking damage

public class EnemyBlindMario 
{
