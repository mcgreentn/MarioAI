...
//commented out/replaced the createAction() calls in createPossibleActions() and extractPlan() that had true for speed parameter (fifth parameter)

public class NoBButtonMario 
{
