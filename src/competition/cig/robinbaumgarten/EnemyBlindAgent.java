...
import competition.cig.robinbaumgarten.astar.EnemyBlindMario;

public class EnemyBlindAgent implements Agent
{
	protected boolean action[] = new boolean[Environment.numberOfButtons];
	protected String name = "RobinBaumgarten_AStarAgent";
//	private AStarSimulator sim;
	//private LimitedJumpMario sim;
	private EnemyBlindMario sim;
	...
	int errCount = 0;
	EnemyBlindAgent errAgent;
	public void reset()
	{
		action = new boolean[Environment.numberOfButtons];
//		sim = new AStarSimulator();
		//sim = new LimitedJumpMario();
		sim = new EnemyBlindMario();
		//sim = new ShortSightedMario();
